...
- פתחו את `source/trip-template.xlsx` ובחרו **קובץ ← שמירה כעותק ב-Google Drive** (או פשוט צרו גיליון Google Sheets חדש והעתיקו לתוכו את התוכן).
...
![הכנת הגיליון](docs/images/sheets-2-tabs.svg)
...
![שיתוף הגיליון](docs/images/sheets-1-share.svg)
...
![הדבקת הקישור באפליקציה](docs/images/sheets-3-paste-link.svg)
